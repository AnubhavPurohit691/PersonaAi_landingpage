      ...
      <div className='flex flex-col md:flex-row justify-between items-start gap-8 md:gap-0'>
        {paragraph.map((p) => {
          return (
            <div
              key={p.id}
              className='flex-1 flex flex-col items-center text-center px-6 md:border-r border-gray-200 last:border-r-0 w-full border-b md:border-b-0 pb-8 md:pb-0 last:border-b-0 last:pb-0'
            >
